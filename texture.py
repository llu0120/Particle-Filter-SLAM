...
import os
os.chdir(r'/Users/LuLienHsi/Desktop/UCSD_Documents/2019_Winter/ECE276A_Sensing&EstimationRobotics/ECE276A_HW2/data') #go into directory 
...
#%%
best_particle_state = np.load('best_state.npy')
backgroundmap = np.load('lamda.npy')
...
#%%
encoder_time_stamps = np.load('encoder_time.npy')
kinect = kinect()
...
for i in range(len(best_particle_state_scaled)):
    print(i)
    os.chdir(r'/Users/LuLienHsi/Desktop/UCSD_Documents/2019_Winter/ECE276A_Sensing&EstimationRobotics/ECE276A_HW2/dataRGBD/RGB20') #go into directory 
